...
manual_model = {'BNBUSDT':1.50368492e-02,'BTCUSDT':1.15671271e-05, 'ETHUSDT':-1.36931337e-03}
...
def stopped_out(dict1, i, tickers, prices, positions, position_prices, curr_val):
    ...
    for ticker in tickers: 
        ...
        dict1 = write_to_dict(dict1, i, ticker, buy_sell, prices[ticker], abs(positions[ticker]))
...
def change_positions(new_status, position_ratios, dict1, i, prices): 
    ...
    for pos in positions: 
        ...
        dict1 = write_to_dict(dict1, i, pos, buy_sell, prices[pos][i], abs(positions[pos]))
...
def set_position_prices(prices, i):
    ...
    for ticker in prices: 
        position_prices[ticker] = prices[ticker][i]
...
def determine_equity(equity, position_prices, prices, positions, i, position_ratios, open_close=None): #I believe something is wrong here and the function needs to be reworked
    ...
    for pos in positions: 
        ...
        if positions[pos] > 0: 
            print(prices[pos][order_val])
            print(position_prices[pos])
...
#this needs to be edited, there are several errors in here with equity
